...
export default function Post(props) {
    var index = props.index  //post index
        ...
        && <><TouchableOpacity onPress={openStory}>
                ...
                <HStack height='50px' alignItems='center'>
                    ...
                    <View style={{ justifyContent: 'center' }}>
                        <VStack>
                            ...
                            {item.overalltitle != '' && <Text fontWeight={'bold'} numberOfLines={1}>{item.overalltitle}</Text>}
            ...
            <Swiper loop={false} style={{ height: 300, backgroundColor: '#f0f0ed', }}
                ...
                {item.image.map((itemI, indexI) => {
                    return (
                        <TouchableOpacity onPress={openStory} delayPressIn={delayPressIn}>
                            <View style={{
